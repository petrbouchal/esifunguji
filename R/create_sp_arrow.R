make_yearly_consolidated_budget <- function(table_file, polozka_codelist, months) {
...
load_budget_yearsum_local <- function(table_file, months, codelists) {
  ...
  b_base <- make_yearly_consolidated_budget(table_file, polozka, months)
